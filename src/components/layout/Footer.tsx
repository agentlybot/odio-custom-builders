...
export function Footer() {
  ...
  return (
    <footer className="bg-navy-900 text-white">
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-navy-800 to-navy-900 py-16">
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Every Great Renovation Starts Somewhere
            </h2>
            <p className="text-neutral-300 text-lg mb-8">
              Whether you need a quick repair before closing or you&apos;re dreaming
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <p className="text-neutral-400 mb-6">
                ...
                closing repairs, home maintenance, and transformative renovations.
              </p>
