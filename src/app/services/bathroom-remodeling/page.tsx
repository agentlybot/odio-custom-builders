...
export const metadata: Metadata = {
  ...
  description: "Transform your bathroom with Odio Custom Builders. From powder rooms to spa-like master baths, we handle every detail in Greenville, SC. Free consultation.",
